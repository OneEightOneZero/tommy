      ...
      <div class="info_box">
        ...
        <div class="info_box__bd">
          <div class="album">
            ...
            <div class="album__bd">
              <h1 class="album__name js_info_show" v-html="title"></h1>
            </div>
          </div>
          <div class="opt_box">
            <a class="btn_play_all" href="javascript:;" v-show="songs.length>0">播放全部</a>
            <div class="play_bar" style="display:none">
              ...
              <div class="play_bar__bd">
                <h2 class="song_name">
                  <span class="song_name__txt" id="js_current_song"></span>
                  <img
                ...
                <div class="lyrics" id="js_lyric_txt">
                  <div class="lyrics__bd" id="js_lrc_show"></div>
                </div>
              </div>
              ...
              <div class="qui_list__bd">
                <div class="qui_list__box">
                  <h3 class="qui_list__tit">
                    <span class="qui_list__txt">{{song.name}}</span>
                  </h3>
                  <p class="qui_list__desc">
                    <span class="qui_list__txt">{{song.album}}-{{song.singer}}</span>
                  </p>
                </div>
              </div>
            </li>
...
import { getSingerDetail } from "../configs/redata.js";
    ...
    _getSingerDetail() {
      ...
      getSingerDetail(this.singer.id).then(res => {
        if (res.code === ERR_OK) {
          ...
          this.songs= this._getSongList(res.data.list);
